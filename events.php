                                        ...
                                        <div class="col-md-3">
                                            <div class="project-item main-color-1-bg-hover project-item-1600">
                                                    <div class="item-thumbnail dark-div">
                                                        <a href="<?php echo SITE_URL; ?>event/<?php echo $eventObj->id.'/'.StringManipulator::slugify($eventObj->name); ?>/" title="<?php echo $eventObj->name; ?>" title="<?php echo $eventObj->name; ?>">
                                                            <img src="<?php echo $eventObj->image; ?>" style="max-height:258px;max-width:409px"  width="409" height="258" title="<?php echo $eventObj->name; ?>" alt="<?php echo $eventObj->name; ?>">
                                                        </a>
                                                    <div class='thumbnail-hoverlay main-color-1-bg'></div>
                                                    <div class='thumbnail-hoverlay-icon'>
                                                        <a href="<?php echo SITE_URL; ?>event/<?php echo $eventObj->id.'/'.StringManipulator::slugify($eventObj->name); ?>/" title="View Full Details"><i class="fa fa-link"></i></a>
                                                    </div>
                                                </div><!--item-thumbnail-->
                                                <div class="project-item-content text-center">
                                                    <div class="project-item-title">
                                                            ...
                                                            <h4 class="item-title"><a href="<?php echo SITE_URL; ?>event/<?php echo $eventObj->id.'/'.StringManipulator::slugify($eventObj->name); ?>/" title="View Full Details"><?php echo $eventObj->name; ?></a></h4>
                                                            <div class="project-item-tax small-text text-left" style="margin-left:10px">
                                                                <div class="ev-start small-text"><i class="fa fa-calendar"></i> <?php echo explode(' ', $eventObj->dateTime)[0]; ?></div>
                                                                <div class="ev-start small-text"><i class="fa fa-clock-o"></i> <?php echo explode(' ', $eventObj->dateTime)[1]; ?></div>
                                                                <div class="ev-start small-text"><i class="fa fa-map-marker"></i> <?php echo $eventObj->location; ?></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="project-item-excerpt">
                                                        <div class="exerpt-text text-justify"><?php echo StringManipulator::trimStringToFullWord(160, trim(stripcslashes(strip_tags($eventObj->description)))); ?>&hellip; <a href="<?php echo SITE_URL; ?>event/<?php echo $eventObj->id.'/'.StringManipulator::slugify($eventObj->name); ?>/" class="btn btn-danger btn-sm text-success" style="max-height:25px;padding:2px;border-color:transparent">More</a></div>
                                                    </div>
                                                </div><!--item-content-->
                                            </div>
                                        </div><!--col-md-3-->
