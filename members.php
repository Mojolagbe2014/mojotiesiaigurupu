                                            ...
                                            <div class="member-item col-md-4">
                                                <div class="member-item-inner">
                                                    <div class="item-thumbnail">
                                                        <a href="<?php echo SITE_URL.'member/'.$memberObj->id.'/'.StringManipulator::slugify($memberObj->name); ?>/" title="<?php echo $memberObj->name; ?>">
                                                            <img width="360" height="360" src="<?php echo $memberObj->picture; ?>" class="attachment-thumb_526x526 wp-post-image" alt="<?php echo $memberObj->name; ?>" />            </a>
                                                    </div>
                                                    <div class="item-content">
                                                        <h3 class="item-title"><a href="<?php echo SITE_URL.'member/'.$memberObj->id.'/'.StringManipulator::slugify($memberObj->name); ?>/" title="title" class="main-color-1-hover"><?php echo $memberObj->name; ?></a></h3>
                                                        <div class="text-info" style="display:block;line-height:1.3;font-size:9px;text-transform:none; margin-bottom:6px">(<?php echo $memberObj->qualification; ?>)</div>
                                                        <h4 class="small-text text-success"><?php echo $memberObj->field; ?></h4>
                                                        <p style="text-align:justify"><?php echo StringManipulator::trimStringToFullWord(160, trim(stripcslashes(strip_tags($memberObj->bio)))); ?></p>
